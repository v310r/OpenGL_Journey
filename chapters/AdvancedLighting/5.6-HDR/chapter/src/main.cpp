...
static const std::array<glm::vec3, 5> s_platformPositions =
{
...
static const std::array<glm::vec3, 5> s_platformRotations =
{
...
static const std::array<glm::vec3, 5> s_lightCubePositions =
{
	glm::vec3{ -97.0f, 0.0f, 2.0f },
	glm::vec3{ -97.0f,  0.0f, -2.0f},
	glm::vec3{ -97.0f, 2.0f, 0.0f },
	glm::vec3{ -97.0f, 4.0f, 0.0f },
	glm::vec3{ -97.0f, -4.0f, 0.0f }
};
...
int main()
{
	...
	SPointLightCube pointLightCube;
	{
		...
		pointLightCube.PointLightData.SetIntensity(200.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		HDRFramebufferTarget.BindColorAttachment();
		toneMappingPostProcessShader->SetInt("screenTexture", HDRFramebufferTarget.GetColorAttachmentTextureUnit());
