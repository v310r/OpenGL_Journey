...
out VertexOutput
{
	vec4 LightViewFragmentPosition; // assume this is directional light
	vec3 Normal;
...
void main()
{
	...
	vertexOutput.LightViewFragmentPosition = lightViewProjMatrix * vec4(worldFragmentPosition, 1.0f);
}